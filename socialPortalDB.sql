...
START TRANSACTION;
USE `DB_SOCIAL_PORTAL`;
INSERT INTO `DB_SOCIAL_PORTAL`.`USER_T` (`USER_ID`, `ROLE_ID`, `PREFERRED_LANGUAGE_ID`, `FIRST_NAME`, `SECOND_NAME`, `EMAIL`, `PASSWORD`, `BIRTHDAY`, `LAST_TIME_ONLINE`, `PHONE_NUMBER`, `POSTAL_CODE`, `STREET`, `CITY`, `PROFILE_PHOTO_ID`, `MALE`) VALUES (1, 1, 1, 'Bartosz', 'Ujazdowski', 'b.ujazdowski@gmail.com', 'password', '1996-10-26', '2018-01-18 18:52:36', '+48732945210', '99340', 'Lipowa 25', 'Krośniewice', NULL, DEFAULT);
