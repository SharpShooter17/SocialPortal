...
BEGIN
	INSERT INTO NOTIFICATION_T(FOR_USER_ID, TYPE_OF_NOTIFICATION_ID, REFERENCE_ID)    
    VALUES(NEW.TO_USER_ID, 1, NEW.INVITATION_ID);
END$$
...
START TRANSACTION;
USE `DB_SOCIAL_PORTAL`;
INSERT INTO `DB_SOCIAL_PORTAL`.`USER_T` (`USER_ID`, `FIRST_NAME`, `SECOND_NAME`, `EMAIL`, `PASSWORD`, `PROFILE_PHOTO_ID`, `MALE`, `PREFERRED_LANGUAGE_ID`) VALUES (1, 'Bartosz', 'Ujazdowski', 'b.ujazdowski@gmail.com', '$2a$10$da7l/9VRpIPBm1z0LiONwO7wRXMs55.5QOkdpFVQ3/eqO9FBu4IXu', NULL, 1, 1);
INSERT INTO `DB_SOCIAL_PORTAL`.`USER_T` (`USER_ID`, `FIRST_NAME`, `SECOND_NAME`, `EMAIL`, `PASSWORD`, `PROFILE_PHOTO_ID`, `MALE`, `PREFERRED_LANGUAGE_ID`) VALUES (2, 'Foo', 'Bar', 'foo.bar@example.com', '$2a$10$da7l/9VRpIPBm1z0LiONwO7wRXMs55.5QOkdpFVQ3/eqO9FBu4IXu', NULL, 2, 2);
