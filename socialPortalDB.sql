...
-- -----------------------------------------------------
-- Table `DB_SOCIAL_PORTAL`.`TYPES_OF_PICTRUE_T`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `DB_SOCIAL_PORTAL`.`TYPES_OF_PICTRUE_T` ;

CREATE TABLE IF NOT EXISTS `DB_SOCIAL_PORTAL`.`TYPES_OF_PICTRUE_T` (
  `TYPES_OF_PICTRUE_ID` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `TYPE` VARCHAR(4) NOT NULL,
  PRIMARY KEY (`TYPES_OF_PICTRUE_ID`),
  UNIQUE INDEX `TYPES_OF_PICTRUE_ID_UNIQUE` (`TYPES_OF_PICTRUE_ID` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `DB_SOCIAL_PORTAL`.`PICTRUE_T` (
  `PICTRUE_ID` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  INDEX `PICTRUE_TYPE_FK_idx` (`TYPE_ID` ASC),
  CONSTRAINT `PICTRUE_USER_FK`
    FOREIGN KEY (`USER_ID`)
    REFERENCES `DB_SOCIAL_PORTAL`.`USER_T` (`USER_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `PICTRUE_TYPE_FK`
    FOREIGN KEY (`TYPE_ID`)
    REFERENCES `DB_SOCIAL_PORTAL`.`TYPES_OF_PICTRUE_T` (`TYPES_OF_PICTRUE_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `DB_SOCIAL_PORTAL`.`USER_T` (
  ...
  `PROFILE_PHOTO_ID` INT UNSIGNED NULL,
  `MALE` BIT(1) NOT NULL DEFAULT 0,
  `PREFERRED_LANGUAGE_ID` INT UNSIGNED NOT NULL DEFAULT 1,
  PRIMARY KEY (`USER_ID`),
...
CREATE TABLE IF NOT EXISTS `DB_SOCIAL_PORTAL`.`INVITATION_NOTIFICATION_T` (
  `INVITATION_NOTIFICATION_ID` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Data for table `DB_SOCIAL_PORTAL`.`TYPES_OF_PICTRUE_T`
-- -----------------------------------------------------
START TRANSACTION;
USE `DB_SOCIAL_PORTAL`;
INSERT INTO `DB_SOCIAL_PORTAL`.`TYPES_OF_PICTRUE_T` (`TYPES_OF_PICTRUE_ID`, `TYPE`) VALUES (1, 'PNG');
INSERT INTO `DB_SOCIAL_PORTAL`.`TYPES_OF_PICTRUE_T` (`TYPES_OF_PICTRUE_ID`, `TYPE`) VALUES (2, 'GIF');
INSERT INTO `DB_SOCIAL_PORTAL`.`TYPES_OF_PICTRUE_T` (`TYPES_OF_PICTRUE_ID`, `TYPE`) VALUES (3, 'JPG');
INSERT INTO `DB_SOCIAL_PORTAL`.`TYPES_OF_PICTRUE_T` (`TYPES_OF_PICTRUE_ID`, `TYPE`) VALUES (4, 'JPEG');
