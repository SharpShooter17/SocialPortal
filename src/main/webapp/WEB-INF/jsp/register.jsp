...
<t:login>
    <form:form class="form-horizontal" action="/addUser" modelAttribute="user">
        <fieldset>
            <!-- Form Name -->
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <form:input path="email" id="email" name="email" type="text" placeholder="" class="form-control input-md" required="" />
